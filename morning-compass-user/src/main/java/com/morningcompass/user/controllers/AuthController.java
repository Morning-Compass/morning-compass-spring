...
import com.morningcompass.user.dto.auth.login.LoginEmailDto;
import com.morningcompass.user.dto.auth.login.LoginUsernameDto;
import com.morningcompass.user.dto.auth.register.RegisterDto;
import com.morningcompass.user.dto.auth.register.ResendEmailDto;
import com.morningcompass.user.dto.auth.response.AuthResponseDto;
import com.morningcompass.user.models.role.Role;
import com.morningcompass.user.repository.UserRepository;
import com.morningcompass.user.security.jwt.JwtTokenGenerator;
import com.morningcompass.user.security.morningcompasssecurity.CustomUserDetails;
import com.morningcompass.user.security.morningcompasssecurity.EmailUserDetailsService;
import com.morningcompass.user.security.morningcompasssecurity.LoginValidator;
import com.morningcompass.user.security.morningcompasssecurity.UsernameUserDetailsService;
import com.morningcompass.user.service.impl.ConfirmationTokenServiceImpl;
import com.morningcompass.user.service.impl.JsonFileReader;
import com.morningcompass.user.service.impl.UserServiceImpl;
import com.morningcompass.user.models.UserEntity;
import com.morningcompass.user.repository.RoleRepository;
import com.morningcompass.user.security.SecurityConstants;
import com.morningcompass.user.security.morningcompasssecurity.*;
